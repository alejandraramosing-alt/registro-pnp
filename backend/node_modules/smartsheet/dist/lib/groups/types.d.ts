...
export interface GroupsApi {
     ...
     * ```
     */
    listGroups: (options?: RequestOptions<ListGroupsQueryParameters, undefined>, callback?: RequestCallback<ListGroupsResponse>) => Promise<ListGroupsResponse>;
    /**
     * Gets a group by ID.
     *
     ...
     * ```
     */
    createGroup: (options: RequestOptions<undefined, AddGroupBody>, callback?: RequestCallback<AddGroupResponse>) => Promise<AddGroupResponse>;
    /**
     * Updates a group.
     *
     ...
     * ```
     */
    updateGroup: (options: UpdateGroupOptions, callback?: RequestCallback<UpdateGroupResponse>) => Promise<UpdateGroupResponse>;
    /**
     * Deletes a group.
     *
     ...
     * ```
     */
    deleteGroup: (options: DeleteGroupOptions, callback?: RequestCallback<BaseResponseStatus>) => Promise<BaseResponseStatus>;
    /**
     ...
     * ```
     */
    addGroupMembers: (options: AddGroupMembersOptions, callback?: RequestCallback<AddGroupMembersResponse>) => Promise<AddGroupMembersResponse>;
    /**
     ...
     * ```
     */
    removeGroupMember: (options: RemoveGroupMemberOptions, callback?: RequestCallback<BaseResponseStatus>) => Promise<BaseResponseStatus>;
}
