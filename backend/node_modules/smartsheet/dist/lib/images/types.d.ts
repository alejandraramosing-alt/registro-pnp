...
export interface ImagesApi {
     ...
     * ```
     */
    listImageUrls: (options: RequestOptions<undefined, ImageUrl[]>, callback?: RequestCallback<ListImageUrlsResponse>) => Promise<ListImageUrlsResponse>;
    /**
     ...
     * ```
     */
    addImageToCell: (options: AddImageToCellOptions, callback?: RequestCallback<AddImageToCellResponse>) => Promise<AddImageToCellResponse>;
}
/**
