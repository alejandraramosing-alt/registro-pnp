...
export interface SightsApi {
     ...
     * ```
     */
    listSights: (options: RequestOptions<ListSightQueryParameters, undefined>, callback?: RequestCallback<ListSightsResponse>) => Promise<ListSightsResponse>;
    /**
     ...
     * ```
     */
    deleteSight: (options: DeleteSightOptions, callback?: RequestCallback<DeleteSightResponse>) => Promise<DeleteSightResponse>;
    /**
     ...
     * ```
     */
    updateSight: (options: UpdateSightOptions, callback?: RequestCallback<UpdateSightResponse>) => Promise<UpdateSightResponse>;
    /**
     ...
     * ```
     */
    getSightPublishStatus: (options: GetSightPublishStatusOptions, callback?: RequestCallback<SightPublishStatus>) => Promise<SightPublishStatus>;
    /**
     ...
     * ```
     */
    setSightPublishStatus: (options: SetSightPublishStatusOptions, callback?: RequestCallback<SetSightPublishStatusResponse>) => Promise<SetSightPublishStatusResponse>;
    getShare: any;
    listShares: any;
    share: any;
    deleteShare: any;
 ...
 */
export declare enum DashboardParentType {
    FOLDER = "folder",
    WORKSPACE = "workspace"
}
/**
