...
const share_1 = __importDefault(require("../share/share"));
function create(options) {
    const requestor = options.requestor;
    // Legacy shares module (deprecated)
    const shares = (0, share_1.default)(options.apiUrls.workspaces);
    const optionsToSend = {
        url: options.apiUrls.workspaces,
    };
    underscore_1.default.extend(optionsToSend, options.clientOptions);
    /**
    ...
    const getWorkspace = (getOptions, callback) => {
        ...
        return requestor.get(underscore_1.default.extend({}, optionsToSend, urlOptions, getOptions), callback);
    };
    /**
    ...
    const listWorkspaces = (getOptions, callback) => {
        ...
        const options = Object.assign(Object.assign(Object.assign({}, urlOptions), getOptions), { queryParameters: queryParameters });
        return requestor.get(underscore_1.default.extend({}, optionsToSend, options), callback);
    };
    /**
    ...
    const createWorkspace = (postOptions, callback) => {
        ...
        return requestor.post(underscore_1.default.extend({}, optionsToSend, urlOptions, postOptions), callback);
    };
    ...
    const updateWorkspace = (putOptions, callback) => {
        ...
        return requestor.put(underscore_1.default.extend({}, optionsToSend, urlOptions, putOptions), callback);
    };
    const deleteWorkspace = (deleteOptions, callback) => {
        const urlOptions = { url: buildUrl(deleteOptions) };
        return requestor.delete(underscore_1.default.extend({}, optionsToSend, urlOptions, deleteOptions), callback);
    };
    ...
    underscore_1.default.extend(workspaceObject, shares.create(options));
