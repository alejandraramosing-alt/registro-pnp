 ...
 * Share scope
 */
export declare enum ShareScope {
    ITEM = "ITEM",
    WORKSPACE = "WORKSPACE"
}
/**
...
export interface SharingApi {
    listAssetShares: (options: ListSharesOptions, callback?: RequestCallback<ListSharesResponse>) => Promise<ListSharesResponse>;
 ...
 * @returns Sharing API
 */
export declare const createSharing: (options: CreateOptions) => SharingApi;
