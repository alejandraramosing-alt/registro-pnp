...
export interface ReportsApi {
     ...
     * ```
     */
    listReports: (options: RequestOptions<ListReportsQueryParameters, undefined>, callback?: RequestCallback<ListReportsResponse>) => Promise<ListReportsResponse>;
    /**
     ...
     * ```
     */
    sendReportViaEmail: (options: SendReportViaEmailOptions, callback?: RequestCallback<SendReportViaEmailResponse>) => Promise<SendReportViaEmailResponse>;
    /**
     ...
     * ```
     */
    getReportPublishStatus: (options: GetReportPublishStatusOptions, callback?: RequestCallback<ReportPublish>) => Promise<ReportPublish>;
    /**
     ...
     * ```
     */
    setReportPublishStatus: (options: SetReportPublishStatusOptions, callback?: RequestCallback<SetReportPublishStatusResponse>) => Promise<SetReportPublishStatusResponse>;
}
