...
export interface WebhooksApi {
     ...
     * ```
     */
    createWebhook: (options: RequestOptions<undefined, CreateWebhookBody>, callback?: RequestCallback<CreateWebhookResponse>) => Promise<CreateWebhookResponse>;
    /**
     ...
     * ```
     */
    listWebhooks: (options: RequestOptions<ListWebhooksQueryParameters, undefined>, callback?: RequestCallback<ListWebhooksResponse>) => Promise<ListWebhooksResponse>;
    /**
     ...
     * ```
     */
    updateWebhook: (options: UpdateWebhookOptions, callback?: RequestCallback<UpdateWebhookResponse>) => Promise<UpdateWebhookResponse>;
    /**
     ...
     * ```
     */
    deleteWebhook: (options: DeleteWebhookOptions, callback?: RequestCallback<DeleteWebhookResponse>) => Promise<DeleteWebhookResponse>;
    /**
     ...
     * ```
     */
    resetSharedSecret: (options: ResetSharedSecretOptions, callback?: RequestCallback<ResetSharedSecretResponse>) => Promise<ResetSharedSecretResponse>;
}
/**
 * Webhook scope types
 */
