...
export interface AlternateEmailsApi {
     ...
     * ```
     */
    addAlternateEmail(options: AddAlternateEmailOptions, callback?: RequestCallback<AddAlternateEmailResponse>): Promise<AddAlternateEmailResponse>;
    /**
     ...
     * ```
     */
    getAlternateEmail(options: GetAlternateEmailOptions, callback?: RequestCallback<AlternateEmail>): Promise<AlternateEmail>;
    /**
     ...
     * ```
     */
    listAlternateEmails(options: ListAlternateEmailsOptions, callback?: RequestCallback<ListAlternateEmailsResponse>): Promise<ListAlternateEmailsResponse>;
    /**
     ...
     * ```
     */
    makeAlternateEmailPrimary(options: MakeAlternateEmailPrimaryOptions, callback?: RequestCallback<MakeAlternateEmailPrimaryResponse>): Promise<MakeAlternateEmailPrimaryResponse>;
    /**
     ...
     * ```
     */
    deleteAlternateEmail(options: DeleteAlternateEmailOptions, callback?: RequestCallback<BaseResponseStatus>): Promise<BaseResponseStatus>;
}
